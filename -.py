...
#      ...     ..      ..                                                                       
#    x*8888x.:*8888: -"888:                                                                     
#   X   48888X `8888H  8888                  u.    u.                                           
#  X8x.  8888X  8888X  !888>        u      x@88k u@88c.      uL           u                     
                        ...
                        with st.expander(_I):
                                ...
                                if resp.status_code==200:
                                        ...
                                        if manga_list_div:
                                                ...
                                                for title in titles:title_url=title.a[_F];title_name=title_url.split(_L)[1];title_name=title_name.replace('/','');title_name=title_name.title();st.write(f"Title: :green[{title_name}]  \nURL: {title_url}\n")
                        with st.expander(_M):
