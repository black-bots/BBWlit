...
with featured:
	st.image('static/p1.jpg',width=300) st.image('https://static.wixstatic.com/media/0dfae7_8ebd2fd403514153a649d4fc899838e9~mv2.jpg',width=300,use_column_width=False)
